...
You can't just spend all of your time writing code for the pie chart, just to not open it. To open it, you must first save the figure image as a PNG file. Then using the os system to "open pie.png". 

- While I  used "open", Windows uses "start".
